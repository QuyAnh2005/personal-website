        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 dark:text-gray-100 mb-8">
              Exploring the frontiers of artificial intelligence with a focus on large language models, 
              computer vision, and reinforcement learning. Currently researching novel methods to improve 
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {latestBlogPosts.map((post) => (
            <div key={post.id} className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden hover:shadow-md transition-shadow dark:bg-[#1a1a1a]">
              <div className="p-5">
                ...
                <p className="text-gray-700 dark:text-gray-100 mb-4">{post.description}</p>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {featuredProjects.map((project) => (
            <div key={project.id} className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden hover:shadow-md transition-shadow dark:bg-[#1a1a1a]">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          {recentPublications.map((publication) => (
            <div key={publication.id} className="border border-gray-200 dark:border-gray-800 rounded-lg p-5 hover:shadow-md transition-shadow dark:bg-[#1a1a1a]">
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-50">
                <Link href={`/research/${publication.id}`} className="hover:text-blue-600 dark:hover:text-blue-400">
                  {publication.title}
                </Link>
              </h3>
              ...
              <p className="text-gray-700 dark:text-gray-100 mb-4">{publication.description}</p>
